...
const schema = defineSchema({
	...
	kingdoms: defineTable({
		...
		research: v.object({
			...
			r_dr: v.optional(v.object({ pts: v.number(), perc: v.number() })),
			r_ft: v.optional(v.object({ pts: v.number(), perc: v.number() })),
			r_tf: v.optional(v.object({ pts: v.number(), perc: v.number() })),
			r_ld: v.optional(v.object({ pts: v.number(), perc: v.number() })),
			r_lf: v.optional(v.object({ pts: v.number(), perc: v.number() })),
			r_f74: v.optional(v.object({ pts: v.number(), perc: v.number() })),
			r_ht: v.optional(v.object({ pts: v.number(), perc: v.number() })),
			r_fusion: v.optional(v.object({ pts: v.number(), perc: v.number() })),
			r_core: v.optional(v.object({ pts: v.number(), perc: v.number() })),
			r_armor: v.optional(v.object({ pts: v.number(), perc: v.number() })),
			r_long: v.optional(v.object({ pts: v.number(), perc: v.number() })),
		}),
